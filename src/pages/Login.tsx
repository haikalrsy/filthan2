  ...
  const handleEmailLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        if (error.status === 400) {
           throw new Error('Login Gagal (400): Pastikan waktu di HP Anda akurat (Sync Time). Detail: ' + error.message);
        }
        throw error;
      }
      ...
      >
        ...
        <div className="p-10">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            <div className="space-y-3">
              <label className="text-[9px] font-black text-gray-500 uppercase tracking-[0.4em] pl-1 font-mono italic">Encryption Key</label>
              <div className="relative group">
          ...
          <div className="mt-10 relative">
            ...
            <div className="relative flex justify-center text-[8px] font-black uppercase tracking-[0.4em] font-mono italic">
              <span className="px-4 bg-white text-gray-500">Alternative Bypass</span>
            </div>
          </div>
          ...
          <button 
            ...
            disabled={loading}
            className="mt-8 w-full py-4 bg-white border border-gray-200 text-gray-600 font-black rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-3 shadow-inner group font-mono text-[10px] uppercase tracking-widest italic"
          >
          ...
          <div className="mt-10 text-center">
            <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] font-mono italic">
              New User?{' '}
              <Link to="/register" className="text-primary hover:text-gray-900 transition-all underline decoration-primary/30 underline-offset-4">
                Initialize Account
              </Link>
            </p>
          </div>
