        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-8xl font-extrabold mb-8 leading-[0.9] tracking-tighter uppercase font-mono italic text-gray-900">
                Graduate <br />
                <span className="text-gray-900/20">Central</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
                <button
                  ...
                  className="px-10 py-5 bg-gray-900 text-white font-black rounded-2xl shadow-2xl hover:bg-gray-800 transition-all flex items-center justify-center gap-3 uppercase tracking-tighter text-sm group"
                >
                ...
                <button
                  ...
                  className="px-10 py-5 bg-surface-lighter text-gray-900 border border-border font-black rounded-2xl hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-3 uppercase tracking-tighter text-sm group"
                >
      ...
      <div className="max-w-7xl mx-auto py-32 px-6 sm:px-12 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div className="md:w-1/2">
            ...
            <h3 className="text-4xl sm:text-5xl font-black text-gray-900 uppercase italic font-mono leading-none tracking-tighter">Engineered for <br /> Absolute Clarity</h3>
          </div>
